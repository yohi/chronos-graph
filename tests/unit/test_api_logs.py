...
def test_get_recent_logs_format():
    ...
    mock_handler.get_recent.return_value = [
        {"timestamp": "2026-04-14T10:00:00Z", "level": "INFO", "logger": "test", "message": "test message"}
    ]
    ...
    with pytest.MonkeyPatch.context() as mp:
        ...
        # Note: LogEntry fields are already camelCase-ish or single word,
        # but check if timestamp/level/logger/message are preserved.
