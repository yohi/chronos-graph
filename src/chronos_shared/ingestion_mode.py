...
environment variable name of the hybrid ingestion mode setting. ChronosGraph
and ChronosGate import from here to guarantee consistency across the two
independent processes.

Placement rationale: ``chronos_gate/upstream/context_store_client.py`` enforces
